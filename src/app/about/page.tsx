  ...
  return (
    <main className="container mx-auto max-w-4xl px-4 py-16 md:py-24">
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert">
        <p>
          Minha jornada começou no design gráfico e me levou ao desenvolvimento
          web. Hoje, sou especialista em <strong>Next.js</strong> e{" "}
          <strong>React</strong>, criando aplicações modernas que combinam
        ...
        <ul>
          <li>
            <strong>Performance em Primeiro Lugar:</strong> Aplicações rápidas,
            otimizadas e escaláveis usando as melhores práticas do Next.js.
          </li>
          <li>
            <strong>Design que Funciona:</strong> A experiência do usuário não é
            uma etapa final, é o ponto de partida. Penso em UX/UI antes mesmo da
          ...
          <li>
            <strong>Do Design ao Deploy:</strong> Experiência completa no ciclo
            de desenvolvimento, desde o Figma até a implantação do sistema.
          </li>
          <li>
        ...
        <p>
          Como hobby tenho explorado o fantástico mundo da modelagem e impressão
          3D, o que me ajuda a manter a criatividade afiada e a pensar fora da
          caixa. Também estou estudando eletrônica, uma área que sempre me
          fascinou e agora estou tendo a oportunidade de explorar e entender
          mais.
        </p>
      </div>
    </main>
